...
class Car:
    ...
    def __init__(self, car_brand: str, max_speed: int):
        ...
        if not isinstance(car_brand, str):
            raise  TypeError("Название марки вашего автомобиля должно соответствовать типу данных str")
        self.car_brand = car_brand
        if not isinstance(max_speed, int):
            raise TypeError("Максимальная скорость вашего автомобиля должна соответствовать типу int")
        if not max_speed > 0:
            raise ValueError("Максимальная скорость автомобиля должна быть положительным числом")
        self.max_speed = max_speed

    def __str__(self):
        return f"Автомобиль. Марка автомобиля {self.car_brand}. Максимальная скорость {self.max_speed} км/час."
...
class PassengerCar(Car):
    ...
    def __init__(self, car_brand: str, max_speed: int, color: str):
        ...
        Пример:
        >>> car = PassengerCar('Lada', 180, 'Серебристый')
        """
